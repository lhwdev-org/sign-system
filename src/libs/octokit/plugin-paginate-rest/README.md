# plugin-paginate-rest.js for Deno
...
📃 Ported from [@octokit/plugin-paginate-rest 2.17.0](https://github.com/octokit/plugin-paginate-rest.js/tree/23f0e9676ead9f22153a18fbb317a0c564e9aa7c).  
[See this for original license.](https://github.com/octokit/plugin-paginate-rest.js/blob/main/packages/core/LICENSE.md)


## Usage

```js
import { Octokit } from "@octokit/core"; // TODO: url
import {
  paginateRest,
  composePaginateRest,
