...
export interface PaginatingEndpoints {
  ...
  "GET /enterprises/{enterprise}/actions/runner-groups": {
    parameters:
      Endpoints["GET /enterprises/{enterprise}/actions/runner-groups"][
        "parameters"
      ];
    response:
      & Endpoints["GET /enterprises/{enterprise}/actions/runner-groups"][
  ...
  "GET /enterprises/{enterprise}/actions/runners": {
    ...
    response:
      & Endpoints["GET /enterprises/{enterprise}/actions/runners"]["response"]
      & {
        data:
          Endpoints["GET /enterprises/{enterprise}/actions/runners"][
            "response"
          ]["data"]["runners"];
      };
  };
  ...
  "GET /enterprises/{enterprise}/actions/runners/downloads": {
    parameters:
      Endpoints["GET /enterprises/{enterprise}/actions/runners/downloads"][
        "parameters"
      ];
    response:
      Endpoints["GET /enterprises/{enterprise}/actions/runners/downloads"][
  ...
  "GET /orgs/{org}/actions/runner-groups": {
    ...
    response: Endpoints["GET /orgs/{org}/actions/runner-groups"]["response"] & {
      data:
        Endpoints["GET /orgs/{org}/actions/runner-groups"]["response"]["data"][
          "runner_groups"
        ];
    };
  };
  ...
  "GET /orgs/{org}/actions/runners": {
    ...
    response: Endpoints["GET /orgs/{org}/actions/runners"]["response"] & {
      data:
        Endpoints["GET /orgs/{org}/actions/runners"]["response"]["data"][
          "runners"
        ];
    };
  };
  ...
  "GET /orgs/{org}/actions/secrets": {
    ...
    response: Endpoints["GET /orgs/{org}/actions/secrets"]["response"] & {
      data:
        Endpoints["GET /orgs/{org}/actions/secrets"]["response"]["data"][
          "secrets"
        ];
    };
  };
  ...
  "GET /orgs/{org}/credential-authorizations": {
    ...
    response:
      Endpoints["GET /orgs/{org}/credential-authorizations"]["response"];
  };
  ...
  "GET /orgs/{org}/installations": {
    ...
    response: Endpoints["GET /orgs/{org}/installations"]["response"] & {
      data:
        Endpoints["GET /orgs/{org}/installations"]["response"]["data"][
          "installations"
        ];
    };
  };
  ...
  "GET /orgs/{org}/team-sync/groups": {
    ...
    response: Endpoints["GET /orgs/{org}/team-sync/groups"]["response"] & {
      data:
        Endpoints["GET /orgs/{org}/team-sync/groups"]["response"]["data"][
          "groups"
        ];
    };
  };
  ...
  "GET /orgs/{org}/teams/{team_slug}/team-sync/group-mappings": {
    parameters:
      Endpoints["GET /orgs/{org}/teams/{team_slug}/team-sync/group-mappings"][
        "parameters"
      ];
    response:
      & Endpoints["GET /orgs/{org}/teams/{team_slug}/team-sync/group-mappings"][
  ...
  "GET /scim/v2/enterprises/{enterprise}/Groups": {
    ...
    response:
      & Endpoints["GET /scim/v2/enterprises/{enterprise}/Groups"]["response"]
      & {
        data:
          Endpoints["GET /scim/v2/enterprises/{enterprise}/Groups"]["response"][
            "data"
  ...
  "GET /scim/v2/enterprises/{enterprise}/Users": {
    ...
    response:
      & Endpoints["GET /scim/v2/enterprises/{enterprise}/Users"]["response"]
      & {
        data:
          Endpoints["GET /scim/v2/enterprises/{enterprise}/Users"]["response"][
            "data"
  ...
  "GET /scim/v2/organizations/{org}/Users": {
    ...
    response:
      & Endpoints["GET /scim/v2/organizations/{org}/Users"]["response"]
      & {
        data:
          Endpoints["GET /scim/v2/organizations/{org}/Users"]["response"][
            "data"
  ...
  "GET /teams/{team_id}/team-sync/group-mappings": {
    parameters:
      Endpoints["GET /teams/{team_id}/team-sync/group-mappings"]["parameters"];
    response:
      & Endpoints["GET /teams/{team_id}/team-sync/group-mappings"]["response"]
      & {
        data:
          Endpoints["GET /teams/{team_id}/team-sync/group-mappings"][
            "response"
          ]["data"]["groups"];
      };
  };
  ...
  "GET /user/migrations/{migration_id}/repositories": {
    ...
    response:
      Endpoints["GET /user/migrations/{migration_id}/repositories"]["response"];
  };
