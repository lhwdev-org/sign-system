...
📃 Ported from [@octokit/endpoint 6.0.12](https://github.com/octokit/endpoint.js/tree/f8d8d41c4e15ef8d412042b96e11415134c4cdcb).  
[See this for original license.](https://github.com/octokit/endpoint.js/blob/main/packages/core/LICENSE.md)
...
```js
import { endpoint } from "https://cdn.skypack.dev/@octokit/endpoint?dts";
```
  ...
  <tbody align=left valign=top>
    ...
    <tr>
      ...
      <td>
        ...
        <em><code>headers["user-agent"]</code> defaults to <code>octokit-endpoint.js/1.2.3 Deno/4.5.6</code> (where <code>1.2.3</code> is the released version and <code>4.5.6</code> is <code>Deno.version.deno</code>)</em>.<br>
...
const { url, ...options } = myEndpoint(`GET /orgs/{org}/repos`);
fetch(url, options)
```
