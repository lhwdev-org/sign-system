...
> Send parameterized requests to GitHub’s APIs with sensible defaults in Deno


## Ported from Deno

📃 Ported from [@octokit/request 5.6.3](https://github.com/octokit/request.js/tree/d65eb9ff3412a1490b20506e3d815eddc976d09b).  
[See this for original license.](https://github.com/octokit/request.js/blob/main/packages/core/LICENSE.md)
...
```js
import { request } from "@octokit/request"; // TODO: url
```
