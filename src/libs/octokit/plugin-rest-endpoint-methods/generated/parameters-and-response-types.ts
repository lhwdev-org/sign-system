import { Endpoints, RequestParameters } from "../../types/index.ts";
  ...
  actions: {
    ...
    approveWorkflowRun: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["POST /repos/{owner}/{repo}/actions/runs/{run_id}/approve"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    cancelWorkflowRun: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["POST /repos/{owner}/{repo}/actions/runs/{run_id}/cancel"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    createOrUpdateOrgSecret: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["PUT /orgs/{org}/actions/secrets/{secret_name}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
      response:
        Endpoints["PUT /orgs/{org}/actions/secrets/{secret_name}"]["response"];
    };
    createOrUpdateRepoSecret: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["PUT /repos/{owner}/{repo}/actions/secrets/{secret_name}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    createRegistrationTokenForOrg: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["POST /orgs/{org}/actions/runners/registration-token"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    createRemoveTokenForOrg: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["POST /orgs/{org}/actions/runners/remove-token"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
      response:
        Endpoints["POST /orgs/{org}/actions/runners/remove-token"]["response"];
    };
    createRemoveTokenForRepo: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["POST /repos/{owner}/{repo}/actions/runners/remove-token"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    deleteOrgSecret: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["DELETE /orgs/{org}/actions/secrets/{secret_name}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    deleteRepoSecret: {
      parameters:
        ...
        >;
      response:
        Endpoints["DELETE /repos/{owner}/{repo}/actions/secrets/{secret_name}"][
          "response"
        ];
    };
    deleteSelfHostedRunnerFromOrg: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["DELETE /orgs/{org}/actions/runners/{runner_id}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
      response:
        Endpoints["DELETE /orgs/{org}/actions/runners/{runner_id}"]["response"];
    };
    deleteSelfHostedRunnerFromRepo: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["DELETE /repos/{owner}/{repo}/actions/runners/{runner_id}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    deleteWorkflowRun: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["DELETE /repos/{owner}/{repo}/actions/runs/{run_id}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    deleteWorkflowRunLogs: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["DELETE /repos/{owner}/{repo}/actions/runs/{run_id}/logs"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    downloadJobLogsForWorkflowRun: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/actions/jobs/{job_id}/logs"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    downloadWorkflowRunLogs: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/actions/runs/{run_id}/logs"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    getAllowedActionsOrganization: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /orgs/{org}/actions/permissions/selected-actions"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    getArtifact: {
      parameters:
        ...
        >;
      response:
        Endpoints["GET /repos/{owner}/{repo}/actions/artifacts/{artifact_id}"][
          "response"
        ];
    };
    ...
    getGithubActionsPermissionsRepository: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/actions/permissions"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
      response:
        Endpoints["GET /repos/{owner}/{repo}/actions/permissions"]["response"];
    };
    getJobForWorkflowRun: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/actions/jobs/{job_id}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    getOrgPublicKey: {
      parameters:
        ...
        >;
      response:
        Endpoints["GET /orgs/{org}/actions/secrets/public-key"]["response"];
    };
    getOrgSecret: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /orgs/{org}/actions/secrets/{secret_name}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
      response:
        Endpoints["GET /orgs/{org}/actions/secrets/{secret_name}"]["response"];
    };
    ...
    getRepoPublicKey: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/actions/secrets/public-key"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    getRepoSecret: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/actions/secrets/{secret_name}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    getReviewsForRun: {
      parameters:
        ...
        >;
      response:
        Endpoints["GET /repos/{owner}/{repo}/actions/runs/{run_id}/approvals"][
          "response"
        ];
    };
    getSelfHostedRunnerForOrg: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /orgs/{org}/actions/runners/{runner_id}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
      response:
        Endpoints["GET /orgs/{org}/actions/runners/{runner_id}"]["response"];
    };
    getSelfHostedRunnerForRepo: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/actions/runners/{runner_id}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    getWorkflow: {
      parameters:
        ...
        >;
      response:
        Endpoints["GET /repos/{owner}/{repo}/actions/workflows/{workflow_id}"][
          "response"
        ];
    };
    getWorkflowRun: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/actions/runs/{run_id}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    getWorkflowRunUsage: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/actions/runs/{run_id}/timing"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    listArtifactsForRepo: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/actions/artifacts"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
      response:
        Endpoints["GET /repos/{owner}/{repo}/actions/artifacts"]["response"];
    };
    ...
    listRepoSecrets: {
      parameters:
        ...
        >;
      response:
        Endpoints["GET /repos/{owner}/{repo}/actions/secrets"]["response"];
    };
    listRepoWorkflows: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/actions/workflows"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    listRunnerApplicationsForOrg: {
      parameters:
        ...
        >;
      response:
        Endpoints["GET /orgs/{org}/actions/runners/downloads"]["response"];
    };
    listRunnerApplicationsForRepo: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/actions/runners/downloads"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    listSelectedReposForOrgSecret: {
      parameters:
        ...
        >;
      response:
        Endpoints["GET /orgs/{org}/actions/secrets/{secret_name}/repositories"][
          "response"
        ];
    };
    ...
    listSelfHostedRunnersForRepo: {
      parameters:
        ...
        >;
      response:
        Endpoints["GET /repos/{owner}/{repo}/actions/runners"]["response"];
    };
    ...
    setAllowedActionsOrganization: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["PUT /orgs/{org}/actions/permissions/selected-actions"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    setGithubActionsPermissionsRepository: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["PUT /repos/{owner}/{repo}/actions/permissions"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    setSelectedReposForOrgSecret: {
      parameters:
        ...
        >;
      response:
        Endpoints["PUT /orgs/{org}/actions/secrets/{secret_name}/repositories"][
          "response"
        ];
    };
    setSelectedRepositoriesEnabledGithubActionsOrganization: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["PUT /orgs/{org}/actions/permissions/repositories"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
  ...
  activity: {
    ...
    deleteRepoSubscription: {
      parameters:
        ...
        >;
      response:
        Endpoints["DELETE /repos/{owner}/{repo}/subscription"]["response"];
    };
    deleteThreadSubscription: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["DELETE /notifications/threads/{thread_id}/subscription"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    getThreadSubscriptionForAuthenticatedUser: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /notifications/threads/{thread_id}/subscription"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    listReceivedPublicEventsForUser: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /users/{username}/received_events/public"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
      response:
        Endpoints["GET /users/{username}/received_events/public"]["response"];
    };
    listRepoEvents: {
      parameters:
        & RequestParameters
    ...
    listRepoNotificationsForAuthenticatedUser: {
      parameters:
        ...
        >;
      response:
        Endpoints["GET /repos/{owner}/{repo}/notifications"]["response"];
    };
    ...
    markRepoNotificationsAsRead: {
      parameters:
        ...
        >;
      response:
        Endpoints["PUT /repos/{owner}/{repo}/notifications"]["response"];
    };
    markThreadAsRead: {
      parameters:
        & RequestParameters
    ...
    setThreadSubscription: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["PUT /notifications/threads/{thread_id}/subscription"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
  ...
  apps: {
    ...
    deleteInstallation: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["DELETE /app/installations/{installation_id}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
      response:
        Endpoints["DELETE /app/installations/{installation_id}"]["response"];
    };
    deleteToken: {
      parameters:
        & RequestParameters
    ...
    getInstallation: {
      parameters:
        ...
        >;
      response:
        Endpoints["GET /app/installations/{installation_id}"]["response"];
    };
    getOrgInstallation: {
      parameters:
        & RequestParameters
    ...
    getSubscriptionPlanForAccount: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /marketplace_listing/accounts/{account_id}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
      response:
        Endpoints["GET /marketplace_listing/accounts/{account_id}"]["response"];
    };
    getSubscriptionPlanForAccountStubbed: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /marketplace_listing/stubbed/accounts/{account_id}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    listAccountsForPlan: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /marketplace_listing/plans/{plan_id}/accounts"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    listAccountsForPlanStubbed: {
      parameters:
        ...
        >;
      response:
        Endpoints["GET /marketplace_listing/stubbed/plans/{plan_id}/accounts"][
          "response"
        ];
    };
    listInstallationReposForAuthenticatedUser: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /user/installations/{installation_id}/repositories"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    listSubscriptionsForAuthenticatedUserStubbed: {
      parameters:
        ...
        >;
      response:
        Endpoints["GET /user/marketplace_purchases/stubbed"]["response"];
    };
    ...
    redeliverWebhookDelivery: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["POST /app/hook/deliveries/{delivery_id}/attempts"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    scopeToken: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["POST /applications/{client_id}/token/scoped"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
      response:
        Endpoints["POST /applications/{client_id}/token/scoped"]["response"];
    };
    suspendInstallation: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["PUT /app/installations/{installation_id}/suspended"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    unsuspendInstallation: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["DELETE /app/installations/{installation_id}/suspended"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
  ...
  billing: {
    ...
    getGithubPackagesBillingOrg: {
      parameters:
        ...
        >;
      response:
        Endpoints["GET /orgs/{org}/settings/billing/packages"]["response"];
    };
    getGithubPackagesBillingUser: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /users/{username}/settings/billing/packages"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    getSharedStorageBillingOrg: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /orgs/{org}/settings/billing/shared-storage"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    getSharedStorageBillingUser: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /users/{username}/settings/billing/shared-storage"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
  ...
  checks: {
    ...
    createSuite: {
      parameters:
        ...
        >;
      response:
        Endpoints["POST /repos/{owner}/{repo}/check-suites"]["response"];
    };
    get: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/check-runs/{check_run_id}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    getSuite: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/check-suites/{check_suite_id}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    listSuitesForRef: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/commits/{ref}/check-suites"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    setSuitesPreferences: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["PATCH /repos/{owner}/{repo}/check-suites/preferences"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    update: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["PATCH /repos/{owner}/{repo}/check-runs/{check_run_id}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
  ...
  codeScanning: {
    ...
    getSarif: {
      parameters:
        ...
        >;
      response:
        Endpoints["GET /repos/{owner}/{repo}/code-scanning/sarifs/{sarif_id}"][
          "response"
        ];
    };
    listAlertInstances: {
    ...
    listAlertsForRepo: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/code-scanning/alerts"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    listRecentAnalyses: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/code-scanning/analyses"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    uploadSarif: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["POST /repos/{owner}/{repo}/code-scanning/sarifs"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
  ...
  enterpriseAdmin: {
    ...
    getGithubActionsPermissionsEnterprise: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /enterprises/{enterprise}/actions/permissions"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    setGithubActionsPermissionsEnterprise: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["PUT /enterprises/{enterprise}/actions/permissions"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
  ...
  gists: {
    ...
    deleteComment: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["DELETE /gists/{gist_id}/comments/{comment_id}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
      response:
        Endpoints["DELETE /gists/{gist_id}/comments/{comment_id}"]["response"];
    };
    fork: {
      parameters:
        & RequestParameters
    ...
    getComment: {
      parameters:
        ...
        >;
      response:
        Endpoints["GET /gists/{gist_id}/comments/{comment_id}"]["response"];
    };
    getRevision: {
      parameters:
        & RequestParameters
    ...
    updateComment: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["PATCH /gists/{gist_id}/comments/{comment_id}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
      response:
        Endpoints["PATCH /gists/{gist_id}/comments/{comment_id}"]["response"];
    };
  };
  git: {
    createBlob: {
    ...
    deleteRef: {
      parameters:
        ...
        >;
      response:
        Endpoints["DELETE /repos/{owner}/{repo}/git/refs/{ref}"]["response"];
    };
    getBlob: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/git/blobs/{file_sha}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
      response:
        Endpoints["GET /repos/{owner}/{repo}/git/blobs/{file_sha}"]["response"];
    };
    getCommit: {
      parameters:
        & RequestParameters
    ...
    getTag: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/git/tags/{tag_sha}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
      response:
        Endpoints["GET /repos/{owner}/{repo}/git/tags/{tag_sha}"]["response"];
    };
    getTree: {
      parameters:
        & RequestParameters
    ...
    listMatchingRefs: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/git/matching-refs/{ref}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    updateRef: {
      parameters:
        ...
        >;
      response:
        Endpoints["PATCH /repos/{owner}/{repo}/git/refs/{ref}"]["response"];
    };
  };
  gitignore: {
    getAllTemplates: {
  ...
  interactions: {
    ...
    getRestrictionsForRepo: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/interaction-limits"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
      response:
        Endpoints["GET /repos/{owner}/{repo}/interaction-limits"]["response"];
    };
    ...
    removeRestrictionsForRepo: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["DELETE /repos/{owner}/{repo}/interaction-limits"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    setRestrictionsForRepo: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["PUT /repos/{owner}/{repo}/interaction-limits"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
      response:
        Endpoints["PUT /repos/{owner}/{repo}/interaction-limits"]["response"];
    };
  ...
  issues: {
    addAssignees: {
      parameters:
        ...
        >;
      response:
        Endpoints["POST /repos/{owner}/{repo}/issues/{issue_number}/assignees"][
          "response"
        ];
    };
    addLabels: {
    ...
    checkUserCanBeAssigned: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/assignees/{assignee}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
      response:
        Endpoints["GET /repos/{owner}/{repo}/assignees/{assignee}"]["response"];
    };
    create: {
      parameters:
        & RequestParameters
    ...
    createComment: {
      parameters:
        ...
        >;
      response:
        Endpoints["POST /repos/{owner}/{repo}/issues/{issue_number}/comments"][
          "response"
        ];
    };
    createLabel: {
    ...
    deleteLabel: {
      parameters:
        ...
        >;
      response:
        Endpoints["DELETE /repos/{owner}/{repo}/labels/{name}"]["response"];
    };
    deleteMilestone: {
      parameters:
        & RequestParameters
        ...
        >;
      response:
        Endpoints["DELETE /repos/{owner}/{repo}/milestones/{milestone_number}"][
          "response"
        ];
    };
    get: {
    ...
    getComment: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/issues/comments/{comment_id}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    getEvent: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/issues/events/{event_id}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    getMilestone: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/milestones/{milestone_number}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    listComments: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/issues/{issue_number}/comments"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    listEvents: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/issues/{issue_number}/events"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    listEventsForTimeline: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/issues/{issue_number}/timeline"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    listLabelsOnIssue: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/issues/{issue_number}/labels"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    lock: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["PUT /repos/{owner}/{repo}/issues/{issue_number}/lock"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    removeAllLabels: {
      parameters:
        ...
        >;
      response:
        Endpoints["DELETE /repos/{owner}/{repo}/issues/{issue_number}/labels"][
          "response"
        ];
    };
    removeAssignees: {
    ...
    setLabels: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["PUT /repos/{owner}/{repo}/issues/{issue_number}/labels"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    unlock: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["DELETE /repos/{owner}/{repo}/issues/{issue_number}/lock"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    update: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["PATCH /repos/{owner}/{repo}/issues/{issue_number}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    updateComment: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["PATCH /repos/{owner}/{repo}/issues/comments/{comment_id}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    updateLabel: {
      parameters:
        ...
        >;
      response:
        Endpoints["PATCH /repos/{owner}/{repo}/labels/{name}"]["response"];
    };
    updateMilestone: {
      parameters:
        & RequestParameters
        ...
        >;
      response:
        Endpoints["PATCH /repos/{owner}/{repo}/milestones/{milestone_number}"][
          "response"
        ];
    };
  };
  ...
  migrations: {
    ...
    deleteArchiveForAuthenticatedUser: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["DELETE /user/migrations/{migration_id}/archive"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
      response:
        Endpoints["DELETE /user/migrations/{migration_id}/archive"]["response"];
    };
    deleteArchiveForOrg: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["DELETE /orgs/{org}/migrations/{migration_id}/archive"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    downloadArchiveForOrg: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /orgs/{org}/migrations/{migration_id}/archive"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    getArchiveForAuthenticatedUser: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /user/migrations/{migration_id}/archive"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
      response:
        Endpoints["GET /user/migrations/{migration_id}/archive"]["response"];
    };
    getCommitAuthors: {
      parameters:
        & RequestParameters
        ...
        >;
      response:
        Endpoints["GET /repos/{owner}/{repo}/import/authors"]["response"];
    };
    getImportStatus: {
      parameters:
        & RequestParameters
    ...
    getLargeFiles: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/import/large_files"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
      response:
        Endpoints["GET /repos/{owner}/{repo}/import/large_files"]["response"];
    };
    ...
    getStatusForOrg: {
      parameters:
        ...
        >;
      response:
        Endpoints["GET /orgs/{org}/migrations/{migration_id}"]["response"];
    };
    listForAuthenticatedUser: {
      parameters:
        & RequestParameters
    ...
    listReposForAuthenticatedUser: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /user/migrations/{migration_id}/repositories"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    listReposForOrg: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /orgs/{org}/migrations/{migration_id}/repositories"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    mapCommitAuthor: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["PATCH /repos/{owner}/{repo}/import/authors/{author_id}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
  ...
  orgs: {
    ...
    cancelInvitation: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["DELETE /orgs/{org}/invitations/{invitation_id}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
      response:
        Endpoints["DELETE /orgs/{org}/invitations/{invitation_id}"]["response"];
    };
    checkBlockedUser: {
      parameters:
        & RequestParameters
    ...
    checkPublicMembershipForUser: {
      parameters:
        ...
        >;
      response:
        Endpoints["GET /orgs/{org}/public_members/{username}"]["response"];
    };
    convertMemberToOutsideCollaborator: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["PUT /orgs/{org}/outside_collaborators/{username}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    getWebhookDelivery: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /orgs/{org}/hooks/{hook_id}/deliveries/{delivery_id}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    listInvitationTeams: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /orgs/{org}/invitations/{invitation_id}/teams"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    listWebhookDeliveries: {
      parameters:
        ...
        >;
      response:
        Endpoints["GET /orgs/{org}/hooks/{hook_id}/deliveries"]["response"];
    };
    listWebhooks: {
      parameters:
        & RequestParameters
    ...
    removeMembershipForUser: {
      parameters:
        ...
        >;
      response:
        Endpoints["DELETE /orgs/{org}/memberships/{username}"]["response"];
    };
    removeOutsideCollaborator: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["DELETE /orgs/{org}/outside_collaborators/{username}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    removePublicMembershipForAuthenticatedUser: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["DELETE /orgs/{org}/public_members/{username}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
      response:
        Endpoints["DELETE /orgs/{org}/public_members/{username}"]["response"];
    };
    ...
    setPublicMembershipForAuthenticatedUser: {
      parameters:
        ...
        >;
      response:
        Endpoints["PUT /orgs/{org}/public_members/{username}"]["response"];
    };
    unblockUser: {
      parameters:
        & RequestParameters
    ...
    updateWebhookConfigForOrg: {
      parameters:
        ...
        >;
      response:
        Endpoints["PATCH /orgs/{org}/hooks/{hook_id}/config"]["response"];
    };
  };
  packages: {
    deletePackageForAuthenticatedUser: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["DELETE /user/packages/{package_type}/{package_name}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    deletePackageForOrg: {
      parameters:
        ...
        >;
      response:
        Endpoints["DELETE /orgs/{org}/packages/{package_type}/{package_name}"][
          "response"
        ];
    };
    ...
    getAllPackageVersionsForAPackageOwnedByTheAuthenticatedUser: {
      parameters:
        ...
        >;
      response:
        Endpoints["GET /user/packages/{package_type}/{package_name}/versions"][
          "response"
        ];
    };
    ...
    getPackageForAuthenticatedUser: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /user/packages/{package_type}/{package_name}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    getPackageForOrganization: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /orgs/{org}/packages/{package_type}/{package_name}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
  ...
  projects: {
    addCollaborator: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["PUT /projects/{project_id}/collaborators/{username}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    deleteCard: {
      parameters:
        ...
        >;
      response:
        Endpoints["DELETE /projects/columns/cards/{card_id}"]["response"];
    };
    deleteColumn: {
      parameters:
        & RequestParameters
    ...
    listCards: {
      parameters:
        ...
        >;
      response:
        Endpoints["GET /projects/columns/{column_id}/cards"]["response"];
    };
    listCollaborators: {
      parameters:
        & RequestParameters
        ...
        >;
      response:
        Endpoints["GET /projects/{project_id}/collaborators"]["response"];
    };
    listColumns: {
      parameters:
        & RequestParameters
    ...
    moveCard: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["POST /projects/columns/cards/{card_id}/moves"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    moveColumn: {
      parameters:
        ...
        >;
      response:
        Endpoints["POST /projects/columns/{column_id}/moves"]["response"];
    };
    removeCollaborator: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["DELETE /projects/{project_id}/collaborators/{username}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    updateCard: {
      parameters:
        ...
        >;
      response:
        Endpoints["PATCH /projects/columns/cards/{card_id}"]["response"];
    };
    updateColumn: {
      parameters:
        & RequestParameters
  ...
  pulls: {
    checkIfMerged: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/pulls/{pull_number}/merge"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    createReview: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["POST /repos/{owner}/{repo}/pulls/{pull_number}/reviews"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    createReviewComment: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["POST /repos/{owner}/{repo}/pulls/{pull_number}/comments"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    deleteReviewComment: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["DELETE /repos/{owner}/{repo}/pulls/comments/{comment_id}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    getReviewComment: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/pulls/comments/{comment_id}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    listCommits: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/pulls/{pull_number}/commits"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    merge: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["PUT /repos/{owner}/{repo}/pulls/{pull_number}/merge"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    update: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["PATCH /repos/{owner}/{repo}/pulls/{pull_number}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    updateReviewComment: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["PATCH /repos/{owner}/{repo}/pulls/comments/{comment_id}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
  ...
  reactions: {
    createForCommitComment: {
      parameters:
        ...
        >;
      response:
        Endpoints["POST /repos/{owner}/{repo}/comments/{comment_id}/reactions"][
          "response"
        ];
    };
    createForIssue: {
      parameters:
        ...
        >;
      response:
        Endpoints["POST /repos/{owner}/{repo}/issues/{issue_number}/reactions"][
          "response"
        ];
    };
    ...
    createForRelease: {
      parameters:
        ...
        >;
      response:
        Endpoints["POST /repos/{owner}/{repo}/releases/{release_id}/reactions"][
          "response"
        ];
    };
    ...
    listForCommitComment: {
      parameters:
        ...
        >;
      response:
        Endpoints["GET /repos/{owner}/{repo}/comments/{comment_id}/reactions"][
          "response"
        ];
    };
    listForIssue: {
      parameters:
        ...
        >;
      response:
        Endpoints["GET /repos/{owner}/{repo}/issues/{issue_number}/reactions"][
          "response"
        ];
    };
    listForIssueComment: {
  ...
  repos: {
    acceptInvitation: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["PATCH /user/repository_invitations/{invitation_id}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    addCollaborator: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["PUT /repos/{owner}/{repo}/collaborators/{username}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    checkCollaborator: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/collaborators/{username}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    checkVulnerabilityAlerts: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/vulnerability-alerts"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    compareCommits: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/compare/{base}...{head}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    compareCommitsWithBasehead: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/compare/{basehead}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    createCommitComment: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["POST /repos/{owner}/{repo}/commits/{commit_sha}/comments"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    createOrUpdateEnvironment: {
      parameters:
        ...
        >;
      response:
        Endpoints["PUT /repos/{owner}/{repo}/environments/{environment_name}"][
          "response"
        ];
    };
    ...
    declineInvitation: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["DELETE /user/repository_invitations/{invitation_id}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    deleteAutolink: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["DELETE /repos/{owner}/{repo}/autolinks/{autolink_id}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    deleteCommitComment: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["DELETE /repos/{owner}/{repo}/comments/{comment_id}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    deleteDeployKey: {
      parameters:
        ...
        >;
      response:
        Endpoints["DELETE /repos/{owner}/{repo}/keys/{key_id}"]["response"];
    };
    deleteDeployment: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["DELETE /repos/{owner}/{repo}/deployments/{deployment_id}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    deleteInvitation: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["DELETE /repos/{owner}/{repo}/invitations/{invitation_id}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    deleteRelease: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["DELETE /repos/{owner}/{repo}/releases/{release_id}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    deleteReleaseAsset: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["DELETE /repos/{owner}/{repo}/releases/assets/{asset_id}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    deleteWebhook: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["DELETE /repos/{owner}/{repo}/hooks/{hook_id}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    disableAutomatedSecurityFixes: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["DELETE /repos/{owner}/{repo}/automated-security-fixes"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    disableVulnerabilityAlerts: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["DELETE /repos/{owner}/{repo}/vulnerability-alerts"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    downloadTarballArchive: {
      parameters:
        ...
        >;
      response:
        Endpoints["GET /repos/{owner}/{repo}/tarball/{ref}"]["response"];
    };
    ...
    enableAutomatedSecurityFixes: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["PUT /repos/{owner}/{repo}/automated-security-fixes"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    enableVulnerabilityAlerts: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["PUT /repos/{owner}/{repo}/vulnerability-alerts"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    generateReleaseNotes: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["POST /repos/{owner}/{repo}/releases/generate-notes"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    getAutolink: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/autolinks/{autolink_id}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    getCodeFrequencyStats: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/stats/code_frequency"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
      response:
        Endpoints["GET /repos/{owner}/{repo}/stats/code_frequency"]["response"];
    };
    ...
    getCombinedStatusForRef: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/commits/{ref}/status"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    getCommitActivityStats: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/stats/commit_activity"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    getCommunityProfileMetrics: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/community/profile"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
      response:
        Endpoints["GET /repos/{owner}/{repo}/community/profile"]["response"];
    };
    getContent: {
      parameters:
        & RequestParameters
    ...
    getContributorsStats: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/stats/contributors"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    getDeployKey: {
      parameters:
        ...
        >;
      response:
        Endpoints["GET /repos/{owner}/{repo}/keys/{key_id}"]["response"];
    };
    getDeployment: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/deployments/{deployment_id}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    getEnvironment: {
      parameters:
        ...
        >;
      response:
        Endpoints["GET /repos/{owner}/{repo}/environments/{environment_name}"][
          "response"
        ];
    };
    getLatestPagesBuild: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/pages/builds/latest"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
      response:
        Endpoints["GET /repos/{owner}/{repo}/pages/builds/latest"]["response"];
    };
    getLatestRelease: {
      parameters:
        & RequestParameters
    ...
    getPagesBuild: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/pages/builds/{build_id}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    getParticipationStats: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/stats/participation"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
      response:
        Endpoints["GET /repos/{owner}/{repo}/stats/participation"]["response"];
    };
    ...
    getPunchCardStats: {
      parameters:
        ...
        >;
      response:
        Endpoints["GET /repos/{owner}/{repo}/stats/punch_card"]["response"];
    };
    getReadme: {
      parameters:
        & RequestParameters
    ...
    getRelease: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/releases/{release_id}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    getReleaseAsset: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/releases/assets/{asset_id}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    getReleaseByTag: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/releases/tags/{tag}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    getTopPaths: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/traffic/popular/paths"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    getTopReferrers: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/traffic/popular/referrers"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    getViews: {
      parameters:
        ...
        >;
      response:
        Endpoints["GET /repos/{owner}/{repo}/traffic/views"]["response"];
    };
    getWebhook: {
      parameters:
        & RequestParameters
        ...
        >;
      response:
        Endpoints["GET /repos/{owner}/{repo}/hooks/{hook_id}"]["response"];
    };
    ...
    listCommentsForCommit: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/commits/{commit_sha}/comments"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    listCommitStatusesForRef: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/commits/{ref}/statuses"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    listPullRequestsAssociatedWithCommit: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/commits/{commit_sha}/pulls"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    listReleaseAssets: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/releases/{release_id}/assets"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    listWebhookDeliveries: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/hooks/{hook_id}/deliveries"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    mergeUpstream: {
      parameters:
        ...
        >;
      response:
        Endpoints["POST /repos/{owner}/{repo}/merge-upstream"]["response"];
    };
    pingWebhook: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["POST /repos/{owner}/{repo}/hooks/{hook_id}/pings"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    removeCollaborator: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["DELETE /repos/{owner}/{repo}/collaborators/{username}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    renameBranch: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["POST /repos/{owner}/{repo}/branches/{branch}/rename"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    requestPagesBuild: {
      parameters:
        ...
        >;
      response:
        Endpoints["POST /repos/{owner}/{repo}/pages/builds"]["response"];
    };
    ...
    testPushWebhook: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["POST /repos/{owner}/{repo}/hooks/{hook_id}/tests"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    updateCommitComment: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["PATCH /repos/{owner}/{repo}/comments/{comment_id}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    updateInvitation: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["PATCH /repos/{owner}/{repo}/invitations/{invitation_id}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    updateRelease: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["PATCH /repos/{owner}/{repo}/releases/{release_id}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    updateReleaseAsset: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["PATCH /repos/{owner}/{repo}/releases/assets/{asset_id}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    updateWebhook: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["PATCH /repos/{owner}/{repo}/hooks/{hook_id}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
      response:
        Endpoints["PATCH /repos/{owner}/{repo}/hooks/{hook_id}"]["response"];
    };
  ...
  secretScanning: {
    ...
    listAlertsForRepo: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /repos/{owner}/{repo}/secret-scanning/alerts"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
  ...
  teams: {
    addOrUpdateMembershipForUserInOrg: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["PUT /orgs/{org}/teams/{team_slug}/memberships/{username}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    addOrUpdateProjectPermissionsInOrg: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["PUT /orgs/{org}/teams/{team_slug}/projects/{project_id}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    addOrUpdateRepoPermissionsInOrg: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["PUT /orgs/{org}/teams/{team_slug}/repos/{owner}/{repo}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    checkPermissionsForProjectInOrg: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /orgs/{org}/teams/{team_slug}/projects/{project_id}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    checkPermissionsForRepoInOrg: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /orgs/{org}/teams/{team_slug}/repos/{owner}/{repo}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    createDiscussionInOrg: {
      parameters:
        ...
        >;
      response:
        Endpoints["POST /orgs/{org}/teams/{team_slug}/discussions"]["response"];
    };
    ...
    getMembershipForUserInOrg: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /orgs/{org}/teams/{team_slug}/memberships/{username}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
    ...
    listChildInOrg: {
      parameters:
        ...
        >;
      response:
        Endpoints["GET /orgs/{org}/teams/{team_slug}/teams"]["response"];
    };
    ...
    listDiscussionsInOrg: {
      parameters:
        ...
        >;
      response:
        Endpoints["GET /orgs/{org}/teams/{team_slug}/discussions"]["response"];
    };
    listForAuthenticatedUser: {
      parameters:
        & RequestParameters
    ...
    listMembersInOrg: {
      parameters:
        ...
        >;
      response:
        Endpoints["GET /orgs/{org}/teams/{team_slug}/members"]["response"];
    };
    listPendingInvitationsInOrg: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /orgs/{org}/teams/{team_slug}/invitations"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
      response:
        Endpoints["GET /orgs/{org}/teams/{team_slug}/invitations"]["response"];
    };
    listProjectsInOrg: {
      parameters:
        & RequestParameters
        ...
        >;
      response:
        Endpoints["GET /orgs/{org}/teams/{team_slug}/projects"]["response"];
    };
    listReposInOrg: {
      parameters:
        & RequestParameters
        ...
        >;
      response:
        Endpoints["GET /orgs/{org}/teams/{team_slug}/repos"]["response"];
    };
    ...
    removeProjectInOrg: {
      parameters:
        ...
        >;
      response:
        Endpoints["DELETE /orgs/{org}/teams/{team_slug}/projects/{project_id}"][
          "response"
        ];
    };
    removeRepoInOrg: {
      parameters:
        ...
        >;
      response:
        Endpoints["DELETE /orgs/{org}/teams/{team_slug}/repos/{owner}/{repo}"][
          "response"
        ];
    };
  ...
  users: {
    ...
    checkFollowingForUser: {
      parameters:
        & RequestParameters
        & Omit<
          Endpoints["GET /users/{username}/following/{target_user}"][
            "parameters"
          ],
          "baseUrl" | "headers" | "mediaType"
        >;
      response:
        Endpoints["GET /users/{username}/following/{target_user}"]["response"];
    };
